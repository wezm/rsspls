...
* [FreeBSD 13 amd64](https://releases.wezm.net/rsspls/0.2.0rsspls-0.2.0amd64-unknown-freebsd.tar.gz)
* [Linux x86\_64](https://releases.wezm.net/rsspls/0.2.0rsspls-0.2.0x86_64-unknown-linux-musl.tar.gz)
* [MacOS x86\_64](https://releases.wezm.net/rsspls/0.2.0rsspls-0.2.0x86_64-apple-darwin.tar.gz)
<!-- * [Windows x86\_64](https://releases.wezm.net/rsspls/0.2.0rsspls-0.2.0x86_64-pc-windows-msvc.zip) -->

Example to download and extract a binary:

    curl https://releases.wezm.net/rsspls/0.2.0rsspls-0.2.0x86_64-unknown-linux-musl.tar.gz | tar zxf -
